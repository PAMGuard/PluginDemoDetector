...
public class WorkshopProcess extends PamProcess {
	...
	public WorkshopProcess(WorkshopController workshopController) {
		...
		outputDataBlock.setOverlayDraw(new WorkshopOverlayGraphics(outputDataBlock));
		outputDataBlock.setPamSymbolManager(new WorkshopSymbolManager(workshopController, outputDataBlock));
